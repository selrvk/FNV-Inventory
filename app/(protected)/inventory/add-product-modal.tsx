        ...
        <div className="modal-overlay" onClick={() => setOpen(false)}>
          <div className="modal-panel" onClick={e => e.stopPropagation()}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1.5rem" }}>
              <h2 className="modal-title" style={{ marginBottom: 0 }}>Add Product</h2>
            ...
            >
              <div className="modal-field">
                ...
                <input className="modal-input" name="name" placeholder="e.g. A4 Bond Paper" required />
              </div>

              <div className="modal-grid">
                <div className="modal-field">
                  <label className="modal-label">Brand</label>
                  <input className="modal-input" name="brand" placeholder="e.g. Pilot" />
                </div>
                <div className="modal-field">
                  <label className="modal-label">Barcode</label>
                  <input className="modal-input" name="barcode" placeholder="Optional" />
                </div>
              </div>
              ...
              <div className="modal-grid">
                <div className="modal-field">
                  ...
                  <input className="modal-input" name="current_stock" type="number" min="0" placeholder="0" required />
                </div>
                <div className="modal-field">
                  <label className="modal-label">Unit *</label>
                  <select className="modal-input modal-select" name="unit">
              ...
              <div className="modal-grid">
                <div className="modal-field">
                  ...
                  <input className="modal-input" name="price_buy" type="number" step="0.01" min="0" placeholder="0.00" required />
                </div>
                <div className="modal-field">
                  <label className="modal-label">SRP (Sell) *</label>
                  <input className="modal-input" name="price_sell" type="number" step="0.01" min="0" placeholder="0.00" required />
                </div>
              </div>
